 ...
 */
CSDK_API uint8_t* WalletCreateWalletRequest(AppletObj *wallet, size_t *len, size_t nbrOfWords);
 ...
 */
CSDK_API uint8_t* WalletCreateWalletResponse(AppletObj *wallet, const uint8_t *response, size_t responseLength, size_t *mnemonicSentenceLength);
...
* @return command pointer to a char*. The function with fill this "char array" with the appropriate APDU command to be sent by the client
*/
CSDK_API uint8_t* WalletFinishRecoverWalletRequest(AppletObj *wallet, const unsigned char *mnemonicSentence, const size_t mnemonicSentenceLength, const unsigned char *passphrase, const size_t passphraseLength, size_t *len);
 ...
 */
CSDK_API int WalletFinishRecoverWalletResponse(AppletObj *wallet, const uint8_t *response, size_t responseLength);
...
/**
  ...
  * @param[in] algorithm Hash Algorithm to use: 0 default/undefined, 1 ECDSA, 2 EDDSA, 4 EC Schnorr
  ...
  */
CSDK_API uint8_t* WalletSignHashRequest(AppletObj *wallet, const uint8_t *bip_path, size_t bip_path_pength,
